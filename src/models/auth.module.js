...
// AGREGADO: Función para validar la contraseña del usuario
export function validarPassword(usuario, passwordRecibida) {
    // Compara la contraseña guardada con la que el usuario envía en el login
    return usuario.password === passwordRecibida;
} // Fin de validarPassword
